    ...
    <Box position="relative" w="full">
      ...
      >
        <HStack spacing={2} maxW="calc(100% - 20px)" isTruncated>
          <Icon
            as={selectedOption ? FiCheckSquare : FiSquare}
            boxSize={4}
            color={selectedOption ? DS.colors.brand : DS.colors.muted}
          />
          <Text
            fontSize="sm"
            fontWeight="600"
        ...
        >
          ...
          {options.map((opt) => (
            ...
            >
              <HStack spacing={2}>
                <Icon
                  as={value === opt.value ? FiCheckSquare : FiSquare}
                  boxSize={4}
                  color={
...
const PremiumBookingCard = ({ booking, onCancelClick }) => {
  ...
  const handleDownloadInvoice = () => {
    // Aici pui portul corect de la backend-ul tău de payments
    window.open(
      `http://localhost:8080/api/payments/${booking.id}/pdf`,
      "_blank",
    );
  };
  return (
    ...
    >
      ...
      {/* TICKET FOOTER ACTUALIZAT (Cu buton PDF) */}
        ...
        {filteredBookings.length > 0 ? (
          ...
          >
            ...
            <Text fontSize="sm" color={DS.colors.muted} textAlign="center">
              Nu am găsit meciuri conform filtrelor selectate.
            </Text>
          </Flex>
        )}
      </Box>
        ...
        >
          ...
          >
            ...
            <Text fontSize="sm" color={DS.colors.muted} mb={8}>
              ...
              ireversibilă, iar politicile de rambursare se vor aplica.
            </Text>
            <HStack spacing={4}>
              <Button
                flex={1}
